...
images: (/static/images/blogs/blender-anya.png)
---
...
# Slicing
print("Cắt hàng đầu tiên:", arr[0, :])  # Kết quả: [1, 2, 3]
print("Cắt cột thứ hai:", arr[:, 1])    # Kết quả: [2, 5]
...
Hãy xem một ví dụ thực tế về việc sử dụng NumPy để xử lý dữ liệu ảnh đơn giản. Giả sử chúng ta có một ảnh grayscale được biểu diễn dưới dạng ma trận 2D, và chúng ta muốn tăng độ sáng của ảnh bằng cách cộng thêm một giá trị vào tất cả các pixel.
...
# Đảm bảo giá trị pixel không vượt quá 255
...
Ví dụ này minh họa cách NumPy có thể xử lý dữ liệu 2D một cách hiệu quả, áp dụng các phép toán trên toàn bộ mảng mà không cần vòng lặp. Điều này rất hữu ích trong xử lý ảnh, một lĩnh vực quan trọng của AI và Machine Learning.
